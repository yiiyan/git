...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link type="text/css" rel="stylesheet" href="./assets/menu/bootstrap.css">
    <link type="text/css" rel="stylesheet" href="./assets/menu/font-awesome.css">
    <link type="text/css" rel="stylesheet" href="./assets/menu/common(1).css">
    ...
    <script type="text/javascript" src="./assets/menu/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="./assets/menu/bootstrap.js"></script>
    <!--    <script type="text/javascript" src="menu/common(2).js"></script>-->
    <script type="text/javascript" src="./assets/menu/emotions.js"></script>
    <script type="text/javascript" src="./assets/menu/jquery-ui-1.10.3.min.js"></script>
...
<div class="main">
    <div class="form form-horizontal">
        ...
        <table class="tb table-striped">
            ...
            <select id="user">
                <?php if (empty($arr)){?>
                    <option value="0">您好像还没有公众号</option>
                <?php }else{
                    foreach($arr as $val) {?>
...
<script type="text/javascript">
    ...
    function saveMenu() {
        ...
        $('#do').val(dats);
//        $('#form')[0].submit();
        $.post("index.php?r=menu/menu", { di: data, do: dats },
            function(data){
                alert(data);
